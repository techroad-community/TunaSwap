...
import { getSushiSupply, getSushiContract } from '../../../tuna/utils'
import { getSushiAddress } from '../../../tuna/utils'
    ...
    <StyledWrapper>
      ...
      <Card>
        ...
        <Footnote>
          ...
          <FootnoteValue>1,000 TUNA</FootnoteValue>
        </Footnote>
      </Card>
    </StyledWrapper>
  )
